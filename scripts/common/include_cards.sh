...
#MPD settings
declare -a MPD_PORT_LIST=(6600 6600 6601 6603 6604 6602 6605 6600)
declare -a MPD_OUTPUT=("Onboard-PCH HDMI2 (living)" "Onboard-PCH HDMI2 (living)" "Bucatarie" "Onboard-PCH Optical (headset)" "PCI-DGX Optical (dormitor)" "Onboard-PCH Analog (baie)" "PCI-DGX Analog (beci)" "SmallUsb-DAC Optical (pod)")
