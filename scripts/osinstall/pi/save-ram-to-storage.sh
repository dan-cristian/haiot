...
rsync --dry-run --delete-delay --exclude-from=/home/$USERNAME/PYC/scripts/osinstall/pi/rsync-ram-overlay-exclude.txt --log-file=$LOG -rcE --compare-dest=/ $MNT_DIR $MNT_DIR/$OVERLAY_DIR
