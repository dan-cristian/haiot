...
rsync --dry-run --delete-delay -rlHpEAXogtJv --exclude-from=/home/$USERNAME/PYC/scripts/osinstall/pi/rsync-ram-overlay-exclude.txt --log-file=$LOG --compare-dest=$MNT_DIR/ / $MNT_DIR/$OVERLAY_DIR/
