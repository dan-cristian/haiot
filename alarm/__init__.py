...
def handle_event_alarm(gpio_pin_code='', direction='', pin_value=''):
    ...
    if zonealarm:
        ...
        logging.warning('Unexpected mising zone alarm for gpio code {}'.format(gpio_pin_code))

def unload():
    logging.info('Alarm module unloading')
    global initialised
...
def init():
    logging.info('Alarm module initialising')
    alarm_loop.init()
