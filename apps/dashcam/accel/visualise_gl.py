...
def run():
    ...
    angle = 0
    v = read_values()
    #filter.filter_init(v[1]['x'], v[1]['y'], v[1]['z'], v[0]['x'], v[0]['y'], v[0]['z'])
    while True:
        time.sleep(0.2)
        ...
        v = read_values()
        #values = filter.filter_clean(v[1]['x'], v[1]['y'], v[1]['z'], v[0]['x'], v[0]['y'], v[0]['z'])
        x_angle = v[0]['x'] # values[0]
        y_angle = v[0]['y'] #values[1]
