...
def init():
    ...
    if owsensor_loop.init():
        thread_pool.add_interval_callable(owsensor_loop.thread_run, owsensor_loop.P.sampling_period_seconds)
        thread_pool.add_interval_callable(owsensor_loop.thread_run_2, owsensor_loop.P.sampling_period_seconds)
    if rfxcom_run.init():
